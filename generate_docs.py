"""
Generate professionally formatted Word documents for Armageddon Treats Business Plan Audit.
Creates two documents:
  1. Armageddon_Treats_Business_Plan_Audit.docx  (main report)
  2. Armageddon_Treats_Works_Cited.docx           (dedicated references)
"""
...
def build_main_document():
    ...
    doc.save("Armageddon_Treats_Business_Plan_Audit.docx")
    print("Main document saved: Armageddon_Treats_Business_Plan_Audit.docx")
...
def build_works_cited():
    ...
    doc.save("Armageddon_Treats_Works_Cited.docx")
    print("Works Cited saved: Armageddon_Treats_Works_Cited.docx")
